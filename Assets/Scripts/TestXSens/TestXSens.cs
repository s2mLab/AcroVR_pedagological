...
//        Debug.Log("Fix this");
//        XSensModule.nIMUtoConnect = 6; // model.nIMUs;

//        imusMatrixPrev = new XsMatrix[XSensModule.nIMUtoConnect];
//        for (int i = 0; i < XSensModule.nIMUtoConnect; i++)
...
//        nDataFiles = XSensModule.nIMUtoConnect * nDataFilesTypes;
...
//        {
//            indexDataFiles[i] = i * XSensModule.nIMUtoConnect;
//            for (int j = 0; j < XSensModule.nIMUtoConnect; j++)
//            {
...
//        nMsgXInterface = 0;
//        MsgXInterfaceFreeAcc = new string[nMsgSize, XSensModule.nIMUtoConnect];
//        nMsgXInterfaceFreeAcc = new int[XSensModule.nIMUtoConnect];
//        MsgXInterfaceCalAcc = new string[nMsgSize, XSensModule.nIMUtoConnect];
//        nMsgXInterfaceCalAcc = new int[XSensModule.nIMUtoConnect];
//        MsgXInterfaceMagField = new string[nMsgSize, XSensModule.nIMUtoConnect];
//        nMsgXInterfaceMagField = new int[XSensModule.nIMUtoConnect];
//        for (int i = 0; i < XSensModule.nIMUtoConnect; i++)
//        {
...
//        nMsgS2M = 0;
//        msgEuler = new string[nMsgSize, XSensModule.nIMUtoConnect];
//        nMsgEuler = 0;
//        msgKalmanQ = new string[nMsgSize, 3];
//        nMsgKalmanQ = 0;
//        msgRK8Q = new string[nMsgSize, 2];
//        nMsgRK8Q = 0;
//        msgJCS = new string[nMsgSize, XSensModule.nIMUtoConnect];
//        nMsgJCS = 0;
...
//#endif
    ...
    void Update()
    {
        ...
        //if (MainParameters.Instance.softwareRunMode != MainParameters.softwareRunModeType.TestXSensFromDataFiles && !XSensModule.IsConnected)
        //    return;
        ...
        //{
        //    TimeSinceTrialStarted = Time.time;
        //    if (MainParameters.Instance.softwareRunMode == MainParameters.softwareRunModeType.TestXSens)
        //        timeEnd = TimeSinceTrialStarted + 5;
        //    else
        //    {
        //        XSensModule.isReadingReady = true;
        //        timeEnd = TimeSinceTrialStarted;
        //    }
        //    panelTestMessages.SetActive(true);
        //    textTestMessages.text = string.Format("Calibration dans {0:F0}s", timeEnd - TimeSinceTrialStarted);
        ...
        //    {
        //        TimeSinceTrialStarted = Time.time;
        //        if (XSensModule.isReadingReady)
        //        {
        //            //if (MainParameters.Instance.softwareRunMode == MainParameters.softwareRunModeType.TestXSens)
        //            //	XSensModule.Instance.ResetOrientation();
        //            timeEnd = TimeSinceTrialStarted + 2;
        //            textTestMessages.text = "Calibration ...";
        //            calibrationDone = false;
        //            nFrame = 0;
        //            timeStamp.Reset();
        //            timeStamp.Start();
        //            XSensModule.readXSensDataON = true;
        ...
        //    //{
        //    //	mess[nMess] = string.Format("{0}: {1}, {2}, {3}, {4}", runState, XSensModule.initReadXSensDataDone, XSensModule.readXSensDataON, XSensModule.CurrentFrameIdx, nFrame);
        //    //	nMess++;
        //    //}
        //    if (timeEnd - Time.time < 0 || calibrationDone)
        //    {
        //        //TimeSinceTrialStarted = Time.time;                                                                                                  // Debug Marcel (Début)
        //        //timeEnd = TimeSinceTrialStarted + 2;
        ...
        //        TimeSinceTrialStarted = Time.time;
        //        timeEnd = TimeSinceTrialStarted + 2;
        //        textTestMessages.text = string.Format("Calib terminé; Début essai dans {0:F0}s", timeEnd - TimeSinceTrialStarted);
        //        audioS.Play(0);
        //        nFrame = 0;
        //        if (MainParameters.Instance.softwareRunMode == MainParameters.softwareRunModeType.TestXSens)
        //            XSensModule.Instance.PrepareSystem();
        //        else
        //            XSensModule.isReadingReady = true;
        ...
        //        {
        //            if (MainParameters.Instance.softwareRunMode == MainParameters.softwareRunModeType.TestXSens)
        //                timeEnd = TimeSinceTrialStarted + 1;
        //            else
        //                timeEnd = TimeSinceTrialStarted + 100;
        ...
        //    {
        //        if (XSensModule.readXSensDataON)
        //        {
        //            audioS.Play(0);
        //            XSensModule.readXSensDataON = false;
        //            timeTrialDuration = timeNow - TimeSinceTrialStarted;
        //        }
        //        else
        //        {
        //            int i = 0;
...
//        XSensModule.Instance.GetXSensData(nFrame, out imusMatrix, out XsEuler[] imusEuler, out XsVector[] imusAcc);
...
//        XsMatrix[] imusMatrix;
//        XSensModule.Instance.GetXSensData(nFrameXSens, out imusMatrix, out XsEuler[] imusEuler, out XsVector[] imusAcc);
...
//            AnimationF.Instance.textChrono.text = string.Format("{0:0.0}", Time.time - TimeSinceTrialStarted);
...
//        return true;
    ...
    void DisplayLogData()
    {
        ...
        //if (MainParameters.Instance.softwareRunMode == MainParameters.softwareRunModeType.TestXSens)
        //{
        //    for (int i = 0; i < XSensModule.CurrentFrameIdx; i++)
        //    {
        //        sumNumCallback += XSensModule.numCallbackByFrame[i];
        //        if (XSensModule.numCallbackByFrame[i] < minNumCallback)
        //            minNumCallback = XSensModule.numCallbackByFrame[i];
        //        if (XSensModule.numCallbackByFrame[i] > maxNumCallback)
        //            maxNumCallback = XSensModule.numCallbackByFrame[i];
        //        sumNumIMUs += XSensModule.numIMUsByFrame[i];
        //        if (XSensModule.numIMUsByFrame[i] < minNumIMUs)
        //            minNumIMUs = XSensModule.numIMUsByFrame[i];
        //        if (XSensModule.numIMUsByFrame[i] > maxNumIMUs)
        //            maxNumIMUs = XSensModule.numIMUsByFrame[i];
        //        sumNumMs += XSensModule.numMsByFrame[i];
        //        if (XSensModule.numMsByFrame[i] < minNumMs)
        //            minNumMs = XSensModule.numMsByFrame[i];
        //        if (XSensModule.numMsByFrame[i] > maxNumMs)
        //            maxNumMs = XSensModule.numMsByFrame[i];
        //    }

        //    Debug.Log(string.Format("XSens Update rate = {0} hz", XSensModule.UpdateRate));
        //    Debug.Log(string.Format("Temps lecture     = {0:0.00}", timeTrialDuration));
        //    Debug.Log(string.Format("Frames lus        = {0}, {1} ({2})", XSensModule.CurrentFrameIdx + 1, nFramesTrial, nFramesCalib));
        //    Debug.Log(string.Format("Callback          = {0}, {1:0.0}, {2}, {3}", sumNumCallback, sumNumCallback / XSensModule.CurrentFrameIdx, minNumCallback, maxNumCallback));
        //    Debug.Log(string.Format("Senseurs XSens    = {0:0.0}, {1}, {2}", sumNumIMUs / XSensModule.CurrentFrameIdx, minNumIMUs, maxNumIMUs));
        //    Debug.Log(string.Format("Durée frames      = {0:0.00}, {1}, {2}", sumNumMs / XSensModule.CurrentFrameIdx, Math.Round(minNumMs), Math.Round(maxNumMs)));
        //}
        //else
  ...
  //      }
	...
	List<XsMatrix[]> ReadXSensDataFiles(string dataType)
	{
        ...
        //string[,] fileLines = new string[nMaxTextDataFiles, XSensModule.nIMUtoConnect];
        //int nLines = 0;
        //for (int i = 0; i < XSensModule.nIMUtoConnect; i++)
        //{
        ...
        //{
        //	XsMatrix[] imusMatrix = new XsMatrix[XSensModule.nIMUtoConnect];
        //	for (int j = 0; j < XSensModule.nIMUtoConnect; j++)
        //	{
...
//		AnimationF.Instance.buttonPlayImage.color = Color.white;
	...
	{
        //double[,,] eulerData = new double[xEulerData.Count, XSensModule.nIMUtoConnect, 3];
        //int frame = 0;
	...
	{
	//	double[,] eulerData = new double[XSensModule.nIMUtoConnect, 3];
	//	int IMU = 0;
	//	foreach (XsEuler xIMUEuler in xIMUsEuler)
	//	{
