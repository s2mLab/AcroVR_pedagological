...
public enum XsXbusMessageId {
  ...
  XMID_ReqGpsLeverArm = XMID_ReqGnssLeverArm,
  XMID_ReqGpsLeverArmAck = XMID_ReqGnssLeverArmAck,
  XMID_SetGpsLeverArm = XMID_SetGnssLeverArm,
  XMID_SetGpsLeverArmAck = XMID_SetGnssLeverArmAck,
  ...
  XMID_ReqGpsStatus = XMID_ReqGnssStatus,
  XMID_GpsStatus = XMID_GnssStatus,
