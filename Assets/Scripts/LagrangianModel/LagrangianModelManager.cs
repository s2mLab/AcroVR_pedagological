...
public class LagrangianModelSimple : LagrangianModelManager
{
	...
	public override StrucLagrangianModel GetParameters
	{
		get
		{
            ...
            //lagrangianModel.root_upward = 2;
            //lagrangianModel.root_somersault = -4;
            //lagrangianModel.root_tilt = 6;
            //lagrangianModel.root_twist = 5;

            lagrangianModel.root_right = -2;
            lagrangianModel.root_foreward = -3;
            lagrangianModel.root_upward = 1;
            lagrangianModel.root_somersault = 5;    // (salto avant)
            lagrangianModel.root_tilt = 6;          // (tilt a gauche)
            lagrangianModel.root_twist = 4;         // (vrille a gauche)

			lagrangianModel.ddlName = new string[lagrangianModel.nDDL - 6];
			lagrangianModel.ddlName[0] = "RightUpperArm.X";
			lagrangianModel.ddlName[1] = "RightUpperArm.Y";
			lagrangianModel.ddlName[2] = "RightUpperArm.Z";
			lagrangianModel.ddlName[3] = "LeftUpperArm.X";
			lagrangianModel.ddlName[4] = "LeftUpperArm.Y";
			lagrangianModel.ddlName[5] = "LeftUpperArm.Z";
			lagrangianModel.feet = new int[] { 2, 3 };
			lagrangianModel.hand = new int[] { 4, 5 };
