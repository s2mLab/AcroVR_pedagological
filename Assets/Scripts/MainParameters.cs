...
public class MainParameters
{
	...
	public enum softwareRunModeType {AcroVR, TestXSens, TestXSensFromDataFiles};
	/// <summary> Mode de fonctionnement du logiciel (AcroVR, TestXSens ou TestXSensFromDataFiles. </summary>
	public softwareRunModeType softwareRunMode = softwareRunModeType.AcroVR;

	public bool debugDataFileIMUsEulerQ = true;		// Temporaire, utilisé pour debug (création des fichiers IMUs, IMUEuler, qBioRBD, ...)							// Debug Marcel 
	public bool testDataFileDone = false;           // Temporaire, utilisé pour debug (comparer les résultats de différents algorithmes de calcul d'intégration)	// Debug Marcel
	...
	private MainParameters()
	{
		...
		// Initialisation du Mode de fonctionnement du logiciel
        ...
        #region InitDll
        handlesDLL[0] = DllManagement.LoadLib(@"Assets\Scripts\Avatar\Controller\XSensController\XSens\bin\xstypes64.dll");
        handlesDLL[1] = DllManagement.LoadLib(@"Assets\Scripts\Avatar\Controller\XSensController\XSens\bin\xsensdeviceapi64.dll");
        handlesDLL[2] = DllManagement.LoadLib(@"Assets\Scripts\Avatar\Controller\XSensController\XSens\bin\xsensdeviceapi_csharp64.dll");
        #endregion
		...
		languages.french.movementLoadDataFileTxtFile = "Fichiers Données (*.txt)";
		languages.english.movementLoadDataFileTxtFile = "Data Files (*.txt)";
